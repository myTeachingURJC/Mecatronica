    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 1: Contador de 2 bits\n\nCada vez que se aprieta el botón SW1 se incrementa el contador,  \ny su salida se muestra en los LEDs 0 y 1  \n\nCuando llega a su valor máximo (3) se enciende el LED 7",
            "readonly": true
          },
          "position": {
            "x": -32,
        ...
        {
          "id": "76cc8642-7741-43ba-b7b8-aae9d3730372",
        ...
        {
          "id": "73fa31ed-d7a4-4633-b4d7-5dcc3506470e",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "73fa31ed-d7a4-4633-b4d7-5dcc3506470e",
        ...
        },
        {
          ...
          "target": {
            "block": "76cc8642-7741-43ba-b7b8-aae9d3730372",
