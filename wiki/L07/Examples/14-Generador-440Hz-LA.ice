{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "74edb4a2-d56f-48a2-be37-9b125ddf54c2",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "29aa836a-dc32-4d01-bf32-32a97d043187",
          "type": "basic.output",
          "data": {
            "name": "Zumbador",
            "pins": [
        ...
        {
          "id": "05f6d025-6415-47a0-ae81-bb78ccbd16c0",
          "type": "basic.output",
          "data": {
            "name": "CH0",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 14: Generador de señal de 440Hz\n\n* M = 12000000/880Mhz = 13636.36. Redondeo: M=13636\n* Número de bits mínimo: N=14",
            "readonly": true
          },
          "position": {
            "x": 344,
        ...
        {
          "id": "869ea912-f208-44a6-955f-69cdca9920d3",
        ...
        {
          "id": "57aca413-bb96-48a0-9476-2dfb6b474d3a",
          "type": "basic.info",
          "data": {
            "info": "Analizador  \nLógico",
            "readonly": true
        ...
        {
          "id": "6bbe4558-0773-402f-af0f-7f17910b8612",
          "type": "basic.info",
          "data": {
            "info": "Freq: 880Hz",
            "readonly": true
        ...
        {
          "id": "29e6ab5b-4d79-4074-8861-f41dff961d1c",
          "type": "basic.info",
          "data": {
            "info": "Freq: 440Hz",
            "readonly": true
        ...
        {
          "id": "0a4013e9-44d8-426c-8cec-73e2fefdf9e2",
        ...
        {
          "id": "7eebf7ec-d221-4d21-bce5-936dea94463a",
          "type": "62447e536be7017ab6772ce1b0d73a28c2c23f85",
          "position": {
            "x": 520,
            "y": 112
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "869ea912-f208-44a6-955f-69cdca9920d3",
        ...
        },
        {
          ...
          "target": {
            "block": "7eebf7ec-d221-4d21-bce5-936dea94463a",
        ...
        {
          "source": {
            "block": "0a4013e9-44d8-426c-8cec-73e2fefdf9e2",
            "port": "4e8afe74-8f38-4873-97ee-f7585d99a4aa"
          },
          "target": {
            "block": "29aa836a-dc32-4d01-bf32-32a97d043187",
            "port": "in"
          }
        },
        {
        ...
        },
        {
          ...
          "target": {
            "block": "74edb4a2-d56f-48a2-be37-9b125ddf54c2",
            "port": "in"
          }
        },
        {
  ...
  "dependencies": {
    ...
    "62447e536be7017ab6772ce1b0d73a28c2c23f85": {
      "package": {
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "4a36e2d1-a52f-498e-a7a9-072fc3af80a7",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "yellow",
                "name": "clk",
            ...
            {
              "id": "c7f5d710-fd62-437b-bda7-f3625099a387",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[15:0]",
            ...
            {
              "id": "3f3fc1ff-e6b7-4693-aee6-9657b1eb23b8",
            ...
            {
              "id": "972b779f-2b35-417a-82b4-62a5bb449b0c",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "972b779f-2b35-417a-82b4-62a5bb449b0c",
                "port": "7995c7b0-4a39-4a19-aaa4-68f4e469912f",
                "size": 16
              },
              "target": {
                "block": "c7f5d710-fd62-437b-bda7-f3625099a387",
                "port": "inlabel"
              },
              "vertices": [],
              "size": 16
            ...
            {
              "source": {
                "block": "4a36e2d1-a52f-498e-a7a9-072fc3af80a7",
                "port": "outlabel"
              },
              "target": {
                "block": "972b779f-2b35-417a-82b4-62a5bb449b0c",
            ...
            },
            {
              ...
              "target": {
                "block": "3f3fc1ff-e6b7-4693-aee6-9657b1eb23b8",
