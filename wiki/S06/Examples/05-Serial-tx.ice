{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "e2157285-3f30-4b20-9fc5-aa0ba618961a",
          "type": "basic.output",
          "data": {
            "name": "Serial",
            "pins": [
        ...
        {
          "id": "eb1b35cc-f988-4678-8d00-612fe190e433",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "f5337f72-9aa9-4df3-848d-3f9af4e834fd",
          "type": "basic.constant",
          "data": {
            "name": "Caracter",
            "value": "\"A\"",
        ...
        {
          "id": "ea16a38b-05db-495f-a5e6-0bbb4e04e460",
        ...
        {
          "id": "18fa0679-00db-4bff-8a3d-c834b13e8655",
        ...
        {
          "id": "aa1aed47-d541-43b5-a40e-a5bdb8944574",
        ...
        {
          "id": "f26960d9-1297-45c8-aa37-ce0d952d0706",
          "type": "basic.info",
          "data": {
            "info": "# Ejemplo 5: Transmisión Serie  \n\nCada vez que se aprieta el pulsador se envía  \nel carácter \"A\" por el puerto serie al PC",
            "readonly": true
          },
          "position": {
            "x": 408,
        ...
        {
          "id": "9531a96a-177c-4cd9-b412-a7f8181d8e68",
          "type": "basic.info",
          "data": {
            "info": "Transmisor serie asíncrono",
            "readonly": true
          },
          "position": {
            "x": 864,
        ...
        {
          "id": "f01204fd-93ae-4e39-b107-7a0e87b69026",
          "type": "basic.info",
          "data": {
      ...
      "wires": [
        {
          "source": {
            "block": "f5337f72-9aa9-4df3-848d-3f9af4e834fd",
            "port": "constant-out"
          },
          "target": {
            "block": "18fa0679-00db-4bff-8a3d-c834b13e8655",
        ...
        },
        {
          ...
          "target": {
            "block": "ea16a38b-05db-495f-a5e6-0bbb4e04e460",
        ...
        },
        {
          ...
          "target": {
            "block": "e2157285-3f30-4b20-9fc5-aa0ba618961a",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "eb1b35cc-f988-4678-8d00-612fe190e433",
            "port": "out"
          },
          "target": {
            "block": "aa1aed47-d541-43b5-a40e-a5bdb8944574",
